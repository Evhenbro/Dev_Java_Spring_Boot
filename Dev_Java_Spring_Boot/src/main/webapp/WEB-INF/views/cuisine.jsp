				...
				<form:form action="/admin/cuisine" method="POST" modelAttribute="cuisine">
					...
					<div class="form-group row">
						<div class="col-10 ml-auto">
							...
							<a href="/admin/cuisine/cancel<custom:allParams/>" class="btn btn-sm btn-outline-info">Cancel</a>
						</div>
					</div>
				</form:form>
			</div>
					...
					<c:forEach var="cuisine" items="${cuisines.content}">
						<tr>
							...
							<td class="text-center">
								<a href="/admin/cuisine/update/${cuisine.id}<custom:allParams/>" class="btn btn-sm btn-outline-warning">Update</a>
								<a href="/admin/cuisine/delete/${cuisine.id}<custom:allParams/>" class="btn btn-sm btn-outline-danger">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</table>
