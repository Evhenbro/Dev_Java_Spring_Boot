...
public class AdminCuisineController {
	...
	@PostMapping
	public String save(@ModelAttribute("cuisine") @Validated(CuisineFlag.class) Cuisine cuisine, BindingResult bindingResult, Pageable pageable, Model model, SessionStatus sessionStatus) {
