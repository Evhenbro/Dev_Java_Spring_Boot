...
public class Cafe extends AbstractEntityName {
	...
	private List<ua.com.yarema.entity.Table> tables = new ArrayList<>();
	...
	public List<ua.com.yarema.entity.Table> getTables() {
		return tables;
	}
	public void setTables(List<ua.com.yarema.entity.Table> tables) {
		this.tables = tables;
	}
